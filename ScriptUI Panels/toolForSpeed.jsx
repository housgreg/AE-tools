...
////////////////////////////////////////////////////  ici le code pour integrer JSON dans JavaScript ////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////  Forum sur l'erreur : https://community.adobe.com/t5/after-effects-discussions/json-is-undefined-error/td-p/9925025 Et voici le code : https://github.com/douglascrockford/JSON-js //////////////////////////
  ...
  function tweenInit(tweenGroup) {
    ...
    var btnSave = group.add("iconbutton", undefined, getAbsolutePath("save.png"), {
      name: "iconbutton1",
      style: "toolbutton", 
    });
    btnSave.onClick = savePreset;
    btnSave.helpTip = "Save"; //Greg

    var btnDelete = group.add("iconbutton", undefined, getAbsolutePath("delete.png"), {
      name: "iconbutton1",
      style: "toolbutton",
    });
    btnDelete.onClick = deletePreset;
    btnDelete.helpTip = "Delete"; //Greg

    var btnEdit = group.add("iconbutton", undefined, getAbsolutePath("edit.png"), {
      name: "iconbutton1",
      style: "toolbutton",
    });
    btnEdit.onClick = editPresets;
    btnEdit.helpTip = "Edit"; //Greg

    group.spacing = 0; //Greg
  ...
  function displayText(text, callback) {
    ...
    //Greg - mettre le bouton reset en haut a droite
    var btnReset = pal.add("iconbutton", undefined, undefined, {
      style: "toolbutton",
    });
    btnReset.text = "Reset Presets";
