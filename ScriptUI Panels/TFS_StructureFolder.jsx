...
if ( !(panelGlobal instanceof Panel) ) uiWindow.text = "StructureFolder";
...
var btnSettingsWindow = groupLigne2.add("iconbutton", undefined, File.decode(imgSettings_imgString), {name: "imgSettings", style: "toolbutton"});
